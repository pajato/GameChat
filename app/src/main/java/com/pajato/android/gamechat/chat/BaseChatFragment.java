...
public abstract class BaseChatFragment extends BaseFragment {
    ...
    protected void processClickEvent(final View view, final String tag) {
        ...
        switch (view.getId()) {
            ...
            case R.id.optionalEndIcon:
                // Click on the optional end item icon
                processOptionalIconClick(view);
                break;
            default:
    ...
    /** Process the optional end icon click */
    private void processOptionalIconClick(final View view) {

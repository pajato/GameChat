...
/**
 * Manages the game related aspects of the GameGame application.  These include accessing and searching messages;
 * getting, decorating and distributing messages; creating and selecting rooms; etc.
 *
...
public class GameManagerImpl implements GameManager {
    ...
    private static final String TAG = GameManagerImpl.class.getSimpleName();
     ...
     */
    public GameManagerImpl(final Bundle bundle) {
